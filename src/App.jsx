    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">[Chhavi]</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight"> Chhavi's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Cheer's to another amazing year 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — [Tanishk] 💖</h2>
          <p className="final-subtitle">Memmories we will Cherish forever✨</p>
        </section>
      </div>
